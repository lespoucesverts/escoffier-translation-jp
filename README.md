...
[リンク先 PETITES_ANNONCES.md をご覧ください](https://github.com/lespoucesverts/escoffier-translation-jp/blob/master/PETITES-ANNONCES.md)
...
#### NEW!! 分数の表示をMarkdownで一般によく使われているTeX表記に変更しました #####
