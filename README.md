...
-----
Github 超初心者むけにパソコンのWEBブラウザで作業に参加する方法をまとめました。「協力はしたいけれどどうすればいいかわからない」という方はぜひリンク先の[*WEBブラウザでファイルの下準備、下訳、編集、校正に参加する方法*](Docs/commit-via-web-browser.md)をご覧ください。
