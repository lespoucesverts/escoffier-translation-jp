...
とはいえ、お手元のパソコンで好きなエディタを使って作業ができるようにしたいかも知れませんので、その方法を書いておきました。Wikiページの[02_中級編](wiki/02_中級編……エディタ-Atom-を使い、自分のパソコンにリポジトリ（データ）をコピーして作業する)をお読みください。

### 3. Collaborator になるには……

とにかくプルリクエストを重ねて積極的に参加してください。オーナー側がいちいちプルリクエストの内容を確認する必要がないと判断した場合に、Collaboratorに指名させていただきます。Wikiページの[03_中級編2](03_中級編2……Collaborator-になってAtom-で編集して-Pushする)をお読みください
