...
不純物を充分に取り除き、コクがあって風味ゆたかな[ソース・ポワヴラード](#sauce-poivrade)5dlを用意する。提供直前に、泡立てた生クリーム4dl（生クリーム2dlを泡立てて倍量にする）と、小さな三日月の形にしたトリュフのスライスと固茹で卵の白身を加える。

……大型ジビエのコトレットやノワゼット、フィレ料理用。
...
白ワイン2dlとマッシュルームの煮汁2dlにエシャロットのみじん切り大さじ2杯を加えて、$\sfrac{1}{3}$量まで煮詰める。[ソース・ドゥミグラス](#sauce-demi-glace)$\sfrac{1}{2}$Lとトマトピュレ1$\sfrac{1}{2}$dl、デュクセル・セッシュ大さじ4杯を加える。5分間煮立たせ、パセリのみじん切り大さじ$\sfrac{1}{2}$を加える。
