...
\paragraph[Coulis divers]{\texorpdfstring{Coulis\footnote{ピュレよりは水分の多いもの、というのが基本的な理解としては正し
  いが、ここでは特殊な用法となっていることに注意。日本では「クーリ」
  と呼ぶ傾向があるようだが、この語それ自体のアクセント（フランス語の
  アクセントは長音）は最後の i の音にある。ou （発音記号 / u / ）は
  日本語にない音で、一般的日本人の耳には強く感じられるために、このよ
  うな習慣が付いたのだと思われる。少なくとも日本語的な発音で「クーリ」
