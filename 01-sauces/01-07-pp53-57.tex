...
\subsubsection[メートルドテルバター]{\texorpdfstring{メートルドテル\footnote{メートルドテル
  ...
  の性格はほぼ決まっていた。}}{メートルドテルバター}}\label{ux30e1ux30fcux30c8ux30ebux30c9ux30c6ux30eb25ux30d0ux30bfux30fc26}}
...
\paragraph{Beurre de Montpellier}\label{beurre-de-montpellier}}
...
\ldots{}\ldots{}魚の冷製料理に添える。ビュフェの場合には魚を覆いかけて供する。
\end{recette}