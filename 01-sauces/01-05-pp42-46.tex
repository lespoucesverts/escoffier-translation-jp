...
\frsub{Sauce aux Airelles}\hspace{1em}(\emph{Cranberries-Sauce}\footnote{英語のcranberryはツルコケモモ（学名Vaccinium
...
\frsub{Sauce Albert}\hspace{1em}(\emph{Albert-Sauce}\footnote{ザクセン＝コーブルク＝ゴータ公アルバート王配（ヴィクトリア女王の
...
\frsub{Sauce aux Aromates}\hspace{1em}(\emph{Aromatic-Sauce})
...
\frsub{Sauce au Beurre à l'anglaise}\hspace{1em}(\emph{Butter Sauce})
...
\frsub{Sauce aux Câpres}\hspace{1em}(\emph{Capers-Sauce})
...
\frsub{Sauce au Céleri}\hspace{1em}(\emph{Celery-Sauce})
...
\frsub{Sauce Chevreuil}\hspace{1em}(\emph{Roe-buck Sauce}\footnote{英語でノロ鹿のこと。})
...
\frsub{Sauce Crème à l'anglaise}\hspace{1em}(\emph{Cream-Sauce})
...
\frsub{Sauce Crevettes à l'anglaise}\hspace{1em}(\emph{Shrimps-Sauce})
...
\frsub{Sauce Diable}\hspace{1em}(\emph{Devilled Sauce})
...
\frsub{Sauce Ecossaise}\hspace{1em}(\emph{Scotch eggs Sauce})
...
\frsub{Sauce au Fenouil}\hspace{1em}(\emph{Fennel Sauce}\footnote{日本語でフェンネルと呼ばれるものは、（a）主に香草として葉を利用
...
\frsub{Sauce aux Groseilles}\hspace{1em}(\emph{Gooseberry Sauce})
...
\frsub{Sauce Homard à l'anglaise}\hspace{1em}(\emph{Lobster Sauce})
...
\frsub{Sauce aux Huîtres}\hspace{1em}(\emph{Oyster Sauce})
...
\frsub{Sauce brune aux Huîtres}\hspace{1em}(\emph{Brown Oyster Sauce})
...
\frsub{Jus coloré}\hspace{1em}(\emph{Brown Gravy})
...
\frsub{Sauce aux OEufs à l'anglaise}\hspace{1em}(\emph{Eggs Sauce})
...
\frsub{Sauce aux OEufs au beurre à l'anglaise}\hspace{1em}(\emph{Eggs
and Butter Sauce})
...
\frsub{Sauce aux Oignons}\hspace{1em}(\emph{Onions Sauce})
...
\frsub{Sauce au Pain}\hspace{1em}(\emph{Bread Sauce})
...
\frsub{Sauce au Pain frit}\hspace{1em}(\emph{Fried bread Sauce})
...
\frsub{Sauce Persil}\hspace{1em}(\emph{Persley Sauce})
...
\frsub{Sauce aux pommes}\hspace{1em}(\emph{Apple Sauce})
...
\frsub{Sauce au Porto}\hspace{1em}(\emph{Porto Wine Sauce})
...
\frsub{Sauce Raifort chaude}\hspace{1em}(\emph{Horse radish Sauce})
...
\frsub{Sauce Réforme}\hspace{1em}(\emph{Reform Sauce}\footnote{19世紀ロンドンの会員制クラブ、リフォームでフランス人料理長アレクシス・ソワイエが考案したソース。このような場合、Reformを固有名詞扱いとして英語のままとするのが現代のフランス語における考え方だが、20世紀初頭にはまだ、固有名詞さえもフランス語的に言い換えることがごく普通であった。})
...
\frsub{Sauce Sauge et Oignons}\hspace{1em}(\emph{Sage and onions Sauce})
