...
仔鴨をポワレのフォン\footnote{ここでのポワレは蒸し焼きの一種であるから、実際には、火入れの終わっ
  た肉を取り出した後、鍋に適量のフォンを注いで火にかけて残った香味野
  菜から風味を引き出したものを用いる。}から浮き脂を取り除き、でんぷんで軽くとろみ付け
...
本来的には誤りである。元来は白ワインが用いられていた。白ワインを用
