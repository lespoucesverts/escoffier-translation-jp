...
マッシュルームの煮汁3
dlを\untiers{}量まで煮詰める。\protect\hyperlink{sauce-allemande}{ソー
ス・アルマンド}\footnote{エスコフィエはドイツ嫌いであったために、「ドイツ風」の意味であ
  る「ソース・アルマンド」の名称を嫌い、「パリ風ソース」として本書で
  は扱っている。\protect\hyperlink{sauce-allemande}{パリ風ソース（ソース・アルマン
  ド）}原注参照。}\troisquarts{} Lを加え、数分間沸騰
...
\protect\hyperlink{jus-de-veau-brun}{仔牛のジュ}\footnote{本書では「仔牛の茶色いジュ」のレシピは掲載されているが、仔牛の
  ...
  あたり、このソースを「軽く仕上げたグラスドヴィアンドにバターとパ
  セリのみじん切りを加えたもの」と述べている（\protect\hyperlink{sauce-colbert}{ソース・コルベー
  ル}本文参照）。}4 dlを加え、半量になるまで煮詰める。
