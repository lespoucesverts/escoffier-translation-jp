...
\frsub{Sauce Albuféra}\footnote{ナポレオン軍の元帥、ルイ・ガブリエル・スーシェ
...
\frsub{Sauce Américaine}\footnote{アメリケーヌという名称の由来は諸説あるが、19世紀フランスの料理人
...
\frsub{Sauce Aurore}\footnote{夜明けの光、曙光のこと。オーロラの意味もあるため、日本では「オー
...
\frsub{Sauce Béarnaise}\footnote{ベアルヌは旧地方名で、フランス南西部、現在のピレネー・アトラン
...
\frsub{Sauce Béarnaise tomatée, dite Sauce Choron}\footnote{19世紀後半、パリで有名レストラン「ヴォワザン」の料理長を務めた
...
ソース・フォイヨ /
ソース・ヴァロワ}\label{sauce-bearnaise-a-la-glace-de-viande}}

\frsub{Sauce Béarnaise à la glace de viande, dite Foyot, ou Valois}\footnote{ソース・フォイヨの名称は、19世紀〜20世紀初頭にパリにあったレス
...
\subsubsection{ソース・ベルシー}\label{sauce-bercy}}

\frsub{Sauce Bercy}\footnote{パリ東部、セーヌ川左岸にある地名。かつては荷揚げ港があり、19世
...
ソース・バタルド}\label{sauce-au-beurre}}

\frsub{Sauce au Beurre, dite Sauce Bâtarde}\footnote{バタルドは「雑種の、中間の」の意。卵黄とバターだけでとろみを付
...
\frsub{Sauce Bonnefoy, ou Sauce Bordelaise au vin blanc}\footnote{ソース・ボヌフォワの名称は、19世紀中頃にあったレストランの名
...
Lを加え、しばらく弱火 にかけて浮いてくる不純物を丁寧に取り除く\footnote{dépouiller
  デプイエ ≒ écumer エキュメ。}。生クリーム大さじ3杯とバ
ター50gを加えて仕上げる。

\maeaki

\hypertarget{sauce-canotiere}{%
\subsubsection{ソース・カノティエール}\label{sauce-canotiere}}

\frsub{Sauce Canotière}\footnote{小舟の漕ぎ手、の意。}
...
\frsub{Sauce Cardinal}\footnote{カトリックの\ruby{枢機卿}{すうききよう}（カルディナル）の衣が伝
...
\frsub{Sauce Chantilly}\footnote{料理および製菓では生クリームをホイップしたクレーム・シャンティイが
...
\frsub{Sauce Chateaubriand}\footnote{料理において通常、シャトーブリヤンは牛フィレの中心部分を3cm程度
...
\subsubsection{ソース・ショフロワ・オーロール}\label{sauce-chaud-froid-aurore}}

\frsub{Sauce Chaud-froid Aurore}\footnote{夜明け、曙光の意。}
...
\frsub{Sauce Chaud-froid au Vert-pré}\footnote{緑の野原、草原、の意。}
...
\frsub{Sauce Chivry}\footnote{19世紀フランスの作家フレデリック・スリエ
...
\frsub{Sauce aux Crevettes}\footnote{小海老のこと。フランスでよく料理に用いられるのは生の状態で甲殻
...
\frsub{Sauce Diplomate}\footnote{外交官風、の意。繊細で豪華な仕立ての料理に付けられる名称。}
...
\subsubsection{ソース・エストラゴン}\label{sauce-estragon-blanche}}

\frsub{Sauce Estragon}\footnote{ヨモギ科のハーブ。詳しくは茶色い派生ソースの\protect\hyperlink{sauce-chasseur}{ソース・シャスー
  ル}訳注参照。}
...
\frsub{Sauce Groseilles}\footnote{日本語で「すぐりの実」のことだが、こんにちでは「黒すぐり」の方
...
\frsub{Sauce Hollandaise}\footnote{ニューヨーク発祥の朝食メニューとして知られるエッグ・ベネディク
  ト\emph{Egg
...
\frsub{Sauce Hongroise}\footnote{原書でも用いられている語paprikaパプリカはハンガリー語。唐辛子、
...
\subsubsection{ソース・イヴォワール}\label{sauce-ivoire}}

\frsub{Sauce Ivoire}\footnote{象牙、の意。}
...
\subsubsection{ソース・ジョワンヴィル}\label{sauce-joinville}}

\frsub{Sauce Joinville}\footnote{19世紀、7月王政期の国王ルイ・フィリップの第3子、フランソワ・ド
...
\frsub{Sauce Laguipière}\footnote{18世紀末〜19世紀初頭にかけて活躍したフランスを代表する料理人の
...
\frsub{Sauce Livonienne}\footnote{現在のラトビア東北部からエストニア南部にかけての古い地域名、い
...
\frsub{Sauce Maltaise}\footnote{シチリアの南方に位置するマルタ島を中心とした国、マルタはオレン
...
\frsub{Sauce Marinière}\footnote{marinier / marinière \textless{} mare
  ラテン語「海」から派生した語。貝や
...
\frsub{Sauce Matelote blanche}\footnote{水夫風、船員風、の意。}
...
\frsub{Sauce Mornay}\footnote{19世紀中頃にパリのレストラン、デュランの料理長ジョゼフ・ヴォワ
...
\frsub{Sauce Mousseline, dite Sauce Chantilly}\footnote{mousseline
...
\frsub{Sauce Mousseuse}\footnote{細かく泡立った、の意。なお、シャンパーニュのようなvin
...
\subsubsection{ソース・ムタルド}\label{sauce-moutarde}}

\frsub{Sauce Moutarde}\footnote{マスタードのこと。マスタードソースと呼んでもいいが、アメリカ風
  の印象を与えるかも知れない。}
...
\subsubsection{ソース・ナンチュア}\label{sauce-nantua}}

\frsub{Sauce Nantua}\footnote{ローヌ・アルプ地方にあるナンチュア湖でエクルヴィスが穫れること
...
\frsub{Sauce New-burg avec le homard cru}\footnote{ここでは英語由来のソース名のため英語風にカタカナ書きしたが、フ
...
\frsub{Sauce New-burg avec le homard cuit}\footnote{このソースの元となった料理「オマール・ニューバーグ」は、19世紀
...
を殻から外し、やや斜めに厚さ1cm程度にスライスする\footnote{détailler en
  escalopes （デタイエオネスカロプ）= escalopper（エスカロペ）
  エスカロップ（厚さ1〜2cm程度の薄切り）に切る。}。ソテー鍋の内側
...
\frsub{Sauce Noisette}\footnote{ヘーゼルナッツ、はしばみの実。}
...
\frsub{Sauce Orientale}\footnote{フランス語の orient
...
\frsub{Sauce paloise}\footnote{ポーは15世紀以来、ベアルヌ地方の中心都市。}
...
\frsub{Sauce Ravigote}\footnote{ravigote \textless{} ravigoter
...
\subsubsection{魚料理用ソース・レジャンス}\label{sauce-regence-pour-poissons}}

\frsub{Sauce Régence pour Poissons, et garnitures de Poissons}\footnote{ソース・レジャンスという名称については「ブラウン系の派生ソース」の
  \protect\hyperlink{sauce-regence}{ソース・レジャンス}訳注参照。}
...
\subsubsection{鶏料理のガルニチュール用ソース・レジャンス}\label{sauce-regence-pour-garnitures-de-volaille}}

\frsub{Sauce Régence pour garnitures de Volaille}\footnote{わかりやすい例としては、後述の\protect\hyperlink{garniture-regence}{ガルニチュール・レジャンス
  B}参照。}
...
\frsub{Sauce Riche}\footnote{リッチな、裕福な、の意。ソース・ディプロマットがそもそも豪華な
...
\frsub{Sauce Rubens}\footnote{フランドル派の画家、Peter Paul Rubens
  ピーテル・パウル・ルーベ
...
\frsub{Sauce Saint-Malo}\footnote{ブルターニュ地方の港町。観光地として有名であり、バカンスシー
  ズンには多くの人が訪れる。}
...
\frsub{Sauce Smitane}\footnote{サワークリームを意味するロシア語
...
\frsub{Sauce Soubise, ou Coulis d'oignons Soubise}\footnote{18世紀の代表的料理人のひとりFrançois
  Marinフランソワ・マラン
...
\subsubsection{ソース・スーシェ}\label{sauce-souchet}}

\frsub{Sauce Souchet}\footnote{ナポレオン軍の元帥を務めたルイ・スーシェ・アルビュフェラ公爵の
  こと。 正しくはSuchetだが、料理名としては Souchet とも綴られる。
  \protect\hyperlink{sauce-albufera}{ソース・アルビュフェラ}訳注参照。}
...
\frsub{Sauce Tyrolienne}\footnote{そもそも\protect\hyperlink{sauce-choron}{ソース・ショロン}をバターではなく植物
...
\subsubsection{チロル風ソース　クラシック}\label{sauce-tyrolienne-a-l-ancienne}}

\frsub{Sauce Tyrolienne à l'ancienne}\footnote{このレシピは第四版のみ。ここでの
...
\frsub{Sauce Vénitienne}\footnote{ヴェネツィア料理ではさまざまな香草を用いるものがあることから、
...
\frsub{Sauce Véron}\footnote{Luis Véron
...
\frsub{Sauce Villageoise}\footnote{文字通り「村人風」の意。このソースの他にもこの名称を冠した
  料理はあるが由来などは不明。}
...
\frsub{Sauce Villeroy}\footnote{ルイ15世の養育係を務めたヴィルロワ元帥
  François de Villeroi の名を冠したものとされる。}
