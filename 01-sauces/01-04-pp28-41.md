...
<div class="frsubenv">Sauce Mornay</div>
...
<div class="frsubenv">Sauce Mousseline, dite Sauce Chantilly</div>
...
\index[src]{mousseline@Mousseline}
\index[src]{むすりーぬ@ムスリーヌ}
...
<div class="frsubenv">Sauce Mousseuse</div>
...
<div class="frsubenv">Sauce Moutarde</div>
...
<div class="frsubenv">Sauce New-burg avec le homard cru</div>
...
<div class="frsubenv">Sauce New-burg avec le homard cuit</div>
...
[^98]: détailler en escalopes （デタイエオネスカロプ）= escalopper（エ
    スカロペ） エスカロップ（厚さ1〜2 cm程度の薄切り）に切る。
...
<div class="frsubenv">Sauce Noisette</div>
...
\index[src]{noisette@Noisette}
\index[src]{のわせつと@ノワゼット
...
<div class="frsubenv">Sauce Normande</div>
...
<div class="frsubenv">Sauce Orientale</div>
...
<div class="frsubenv">Sauce paloise</div>
...
#### ソース・プレット[^109] {#sauce-poulette}

<div class="frsubenv">Sauce Poulette</div>
...
<div class="frsubenv">Sauce Ravigote</div>
...
<div class="frsubenv">Sauce Régence pour Poissons, et garnitures de Poissons</div>
...
<div class="frsubenv">Sauce Régence pour garnitures de Volaille</div>
...
<div class="frsubenv">Sauce Riche</div>
...
<div class="frsubenv">Sauce Saint-Malo</div>
...
\index[src]{saint-malo@Saint-Malo}
\index[src]{さんまろふう@サンマロ風}
...
<div class="frsubenv">Sauce Smitane</div>
...
\index[src]{smitane@Smitane}
\index[src]{すみたーぬ@スミターヌ}
...
[^127]: サワークリームを意味するロシア語
    \ltjsetparameter{jacharrange={-2}} Сметана
    \ltjsetparameter{jacharrange={+2}}スメタナが由来。ロシア料理とフラ
    ンス料理との相互影響関係にいては、[序 p.II 訳注3](#service-russe)
    および[モスクワ風ソース](#sauce-moscovite)訳注参照。
...
<div class="frsubenv">Sauce Solférino</div>
...
\index[src]{solferino@Solférino}
\index[src]{そるふえりの@ソルフェリノ}
...
<div class="frsubenv">Sauce Soubise, ou Coulis d'oignons Soubise</div>
...
<div class="frsubenv">Sauce Soubise tomatée</div>
...
<div class="frsubenv">Sauce Tyrolienne</div>
...
\index[src]{tyrolienne@Tyrolienne}
\index[src]{ちろるふう@チロル風}
...
#### チロル風ソース・クラシック[^146] {#sauce-tyrolienne-ancienne}

<div class="frsubenv">Sauce Tyrolienne à l'ancienne</div>
...
<div class="frsubenv">Sauce Valois</div>
...
ズ](#sauce-bearnaise-glace-de-viande)のこと（[ソース・ベアルネー
...
<div class="frsubenv">Sauce Vénitienne</div>
...
<div class="frsubenv">Sauce Véron</div>
...
[^149]: Louis Véron (1798〜1867)。医師であり、文学愛好家、美食家として
...
<div class="frsubenv">Sauce Villageoise</div>
...
\index[src]{villageoise@Villageoise}
\index[src]{むらひとふう@村人風}
...
<div class="frsubenv">Sauce Villeroy</div>
...
<div class="frsubenv">Sauce Villeroy Soubisée</div>
...
<div class="frsubenv">Sauce Villeroy tomatée</div>
