...
[グロゼイユのジュレ](#) 2\undemi{} dlを加え、仕上げにオレンジ果汁を加える。
...
[メートルドテルバター](#)に[グラスドヴィアンド](#glace-de-viande)を加
...
……エイのような、あまり高級ではない茹でた魚[^44]用。[](本文要推敲)
...
のブイイ[^107]や牛や羊の[エマンセ](#)にも合わせることが出来る。
...
[^107]: もとはブイヨンをとった後の茹で肉のことを指した。単純に「茹でた
