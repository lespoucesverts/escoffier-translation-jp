...
\index[src]{demi-glace@Demi-glace!artichaut barigoule@Artichauts à la Barigoule}
\index[src]{とうみくらす@ドゥミグラス!あーていちよーくはりくーる@アーティチョーク・バリグール}
...
\frsub{Coeurs d'artichauts Clamart}
...
\frsub{Coeurs d'artichauts Grand-Duc}

\index{artichaut@artichaut!grand-duc@Coeurs d'---s Grand-Duc}
\index{grand-duc@Grand-Duc!artichauts@Coeur d'artichauts ---}
\index{あーていちよーく@アーティチョーク!くらんてゆつく@---の芯・グランデュック}
\index{くらんてゆつく@グランデュック!あーていちよーく@アーティチョークの芯・---}
\index[src]{creme@Crème!artichaut grand-duc@Coeurs d'artichauts Grand-Duc}
\index[src]{くれーむ@クレーム!あーていちよーくのしんくらんてゆつく@アーティチョークの芯・グランデュック}
\index[src]{glace de viande@Glace de viande!artichaut grand-duce@Coeurs d'artichauts Grand-Duc}
\index[src]{くらすとういあんと@グラスドヴィアンド!あーていちよーくのしんくらんてゆつく@アーティチョークの芯・グランデュック}
...
\frsub{Artichauts avec sauce diverses}

\index{artichaut@artichaut!sauces diverses@---s avec sauces diverses}
\index[src]{beurre@au Beurre!artichauts@Artichauts avec sauces diverses}
\index[src]{hollandaise@Hollandaise!artichauts@Artichauts avec sauces diverses}
\index[src]{mousseline@Mousseline!artichauts@Artichauts avec sauces diverses}
\index[src]{vinaigrette@Vinaigrette!artichauts@Artichauts avec sauces diverses}

\index{あーていちよーく@アーティチョーク!いろいろなそーすて@---・いろいろなソースで}
\index[src]{ふーる@オ・ブール!あーていちよーく@アーティチョーク・いろいろなソースで}
\index[src]{おらんてーす@オランデーズ---!あーていちよーく@アーティチョーク・いろいろなソースで}
\index[src]{むすりーぬ@ムスリーヌ!あーていちよーく@アーティチョーク・いろいろなソースで}
\index[src]{ういねくれつと@ヴィネグレット!あーていちよーく@アーティチョーク・いろいろなソースで}
