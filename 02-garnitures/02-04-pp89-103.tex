...
\item
  肉に合わせて中くらいから小さめのアーティチョークの芯\footnote{比較的小ぶりで若どりのアーティチョークは花萼を全部は取り除かず、周囲の固いところを2周くらい剥いて、上半分を切り落し、茎が残っている場合は適当な長さにして皮を剥いて使う。この状態を
    ...
    cul d'artichaut
    （キュダルティショー）と呼ぶ。いずれの場合も繊毛を取り除く必要があり、その後に丸い底面が出来るので、そこに詰め物をすることも多い。}に、溶かした\protect\hyperlink{glace-de-viande}{グラスドヴィアンド}の中に入れて転がしてグラスをコーティングさせた小さな\protect\hyperlink{pommes-de-terre-noisette}{じゃがいものノワゼット}を詰める。
\end{itemize}
