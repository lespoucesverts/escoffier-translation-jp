...
\item
  にんじん500 gは、にんにくのような形に整形して\footnote{tourner
    （トゥルネ）。}下茹でし、バターで色艶よく炒めた\footnote{glacer
...
\item
  茹でたフラジョレ\footnote{\protect\hyperlink{garniture-bretonne}{ガルニチュール・ブルターニュ風}訳注参照。}\undemi{}
  Lを\protect\hyperlink{veloute}{ヴルテ}であえる
\item
...
\item
  芽キャベツ500gは下茹でしてから、バターで蒸し煮する\footnote{étuver
    (エチュヴェ)。下茹での段階で\deuxtiers{}〜\troisquarts{}
...
\subsubsection{ガルニチュール・カスティリア風}\label{garniture-castillane}}
