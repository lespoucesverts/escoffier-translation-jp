...
\item
  ポワヴロン10個はグリル焼きする。
\item
  ソース\ldots{}\ldots{}カイエンヌを強く効かせたトマト風味の\protect\hyperlink{jus-de-veau-lie}{ジュ}。
\end{itemize}
...
\item
  {[}鶏の滑らかなファルス{]}（\#farce-b）で丸く作った小さなクネル10個に、それぞれトリュフのスライスをのせる。
\item
...
\subsubsection{ガルニチュール・ミレット}\label{garniture-mirette}}
...
\item
  \protect\hyperlink{pommes-de-terre-mirette}{じゃがいものミレット}で作った小さなタンバル\footnote{円筒形にする仕立て。大きなものはmoule
    à
    timbale（ムーラタンバール）という専用の型を用いる。原義は「小太鼓」であり、直径に比べてやや高さのないものが本来の姿だが、19世紀にはかなり高さのある円筒形の仕立てにもこの名称が用いられた。}仕立て10個。
\item
