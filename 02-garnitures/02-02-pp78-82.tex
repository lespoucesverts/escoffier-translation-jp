...
\subsubsection[ポタージュ用そば粉のカシュ]{\texorpdfstring{ポタージュ用そば粉のカシュ\footnote{Kacha
  （カシャ）とも。日本語ではカーシャと呼ばれることもある。もとはロシアをはじめとするスラブ諸国における粥の総称でロシア語\ltjsetparameter{jacharrange={-2}}каша\ltjsetparameter{jacharrange={+2}}フランス料理に取り入れられ、そば粉またはセモリナ粉でつくったクレープのようなものを意味するようになった。}}{ポタージュ用そば粉のカシュ}}\label{kache-de-sarrazin-pour-potage}}
...
\subsubsection{クリビヤック用セモリナ粉のカシュ}\label{kache-de-semoule-pour-coulibiac}}
