...
アスピックのガルニチュールが種々のエスカロップ[^13]や長方形に切ったフォワグ
...
\noindent\textbf{型から外す方法}……型を湯につけてただちに水気を拭い、折り
...
[^8]: パンで作るクルトンと同様に、菱形やさいの目に切った冷製料理装飾用
    のジュレもクルトンと呼ぶ。
...
[^10]: moule à bordure （ムーラボルデュール）蛇の目形に料理の縁り飾り
    を作るための、やや丈が低く中央の穴が大きいリング型。
...
[^17]: chaud-froid このchaud（熱い）とfroid（冷たい）の合成語の複数形は、それぞれ
    にsを付ける、chauds-froidsとなる。合成語の複数形はいろいろなパターンがあるので、必要が
    出たらその都度覚えるようにしたほうがいい。
...
[^21]: いわゆる「サラダ菜」に属する系統の結球レタスのこと。現代では
...
他のどんなレシピでもそうだが、それぞれのガルニチュールを構成している原
則を勝手に変えてはいけない。もしも、どうしても何らかの変更が必要ならば、
それは料理本体に合わせて、配置を変えるとか、見た目の形状を変えるだけに
すること。ガルニチュールを構成している素材を変えてはいけない。
...
それでも、アントレについてはそうしたほうがいい。この点で、絶対に守って
いただきたいのは、料理本体の盛り付けとガルニチュールを切り離したほうが、
必ず、より早く料理をご提供できるのだから、どんな盛り付けをする料理であ
ろうと、ためらうことなくこの方式を採用すべきだ、ということだ。
...
[^26]: 約80gの牛フィレ肉の筒切り、および、円筒形に切った羊、仔羊の背肉の中心部分。
...
### 牛、羊肉料理に野菜を添える場合にふさわしいソースについて {#remarque-importante-sur-les-sauces-applicables-aux-entrees-de-boucherie-garnie-de-legumes}
