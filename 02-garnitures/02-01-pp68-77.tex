...
\hypertarget{farces-generalite}{%
\section[ファルス ]{\texorpdfstring{ファルス \footnote{本来は「詰め物」の意で、鶏のローストの内臓を抜いた空洞部分に詰めたり、ガランティーヌやパテアンクルートの内部の詰め物などの用途に用いられる。この意味はこんにちでも変化がないが、本文にあるように、クネルにしてガルニチュールの一部にするなど、用途は多岐にわたる。本書ではファルスとして用いられるもののうち、肉および魚肉をベースにしたものをこの節にまとめて分類、説明している。したがって、ここでファルスとして挙げられていないファルスも料理によっては多い（例えば丸鶏の空洞部分に米などを詰めるのもファルス）ことに注意。}}{ファルス }}\label{farces-generalite}}
...
\hypertarget{panadespourfarces}{%
\subsection[ファルス用のパナードについて]{\texorpdfstring{ファルス用のパナードについて\footnote{パナードは本来、パンと水、バターを弱火で時間をかけて煮た粥のようなものを意味した。本書ではその意味を拡大して肉や魚肉をベースとしたファルスを加熱する際に崩れないようにする「つなぎ」として、この語を用いている。そのため、必ずしもパンを材料としていないものが含まれている。}}{ファルス用のパナードについて}}\label{panadespourfarces}}
...
\vspace*{-1.7\zw}
\begin{recette}
\hypertarget{panade-au-pain}{%
\subsubsection{A. パンのパナード}\label{panade-au-pain}}
...
\item
  ...
  dl、固くなった白パン\footnote{ここではいわゆるバゲットのようなパンの外側を削り落した白い部分、あ
...
\hypertarget{panade-a-la-farine}{%
\subsubsection{B. 小麦粉のパナード}\label{panade-a-la-farine}}
...
パナード・フランジパーヌ\footnote{フランジパーヌとは製菓で用いられる、小麦粉、砂糖、卵を混ぜて牛
  ...
  ター」のことなので間違えないよう注意。}}{C. パナード・フランジパーヌ}}\label{panade-frangipane}}
...
\hypertarget{panade-au-riz}{%
\subsubsection{D. 米のパナード}\label{panade-au-riz}}
...
\hypertarget{panade-a-la-pomme-de-terre}{%
\subsubsection{E.
じゃがいものパナード}\label{panade-a-la-pomme-de-terre}}
...
われる。
\begin{recette}
\hypertarget{farce-a-la-panade-et-au-beurre}{%
\subsubsection{A.
パナードとバターを用いるファルス}\label{farce-a-la-panade-et-au-beurre}}
...
\hypertarget{farce-a-la-panade-et-a-la-creme}{%
\subsubsection{B.
パナードと生クリームを用いるファルス}\label{farce-a-la-panade-et-a-la-creme}}
...
\hypertarget{farce-mousseline}{%
\subsubsection{C. 生クリームを用いる滑らかなファルス /
ファルス・ムスリーヌ}\label{farce-mousseline}}
...
\hypertarget{farce-de-veau-a-la-graisse-de-boeuf}{%
...
ゴディヴォ\footnote{ゴディヴォgodiveau
  ...
  として扱っているのはまことに正鵠を射ていると言えよう。}}{仔牛肉とケンネ脂のファルス / ゴディヴォ}}\label{farce-de-veau-a-la-graisse-de-boeuf}}
...
\index{こていうお@ゴディヴォ}
\begin{recette}
\hypertarget{godiveau-a}{%
\subsubsection{A. 氷を入れて作るゴディヴォ}\label{godiveau-a}}
...
\hypertarget{godiveau-b}{%
\subsubsection{B. 生クリーム入りゴディヴォ}\label{godiveau-b}}
...
ケンネ脂入りブロシェ\footnote{ノーザンパイク、和名キタカワカマス。}のファルス\footnote{このレシピは第二版以降。}}{C. リヨン風ゴディヴォ / ケンネ脂入りブロシェのファルス}}\label{godiveau-c}}
...
\hypertarget{farcedeveaupourbordures}{%
\subsubsection{盛り付けの縁飾りおよび底に敷いたり、詰め物をしたクネルに用いる仔牛のファルス}\label{farcedeveaupourbordures}}
...
A]{\texorpdfstring{ファルス・グラタン\footnote{ここでゴディヴォのように小見出しがあって然るべきところだが、初
  ...
  いられない。} A}{ファルス・グラタン A}}\label{farcegratina}}
...
\hypertarget{farcegratinb}{%
\subsubsection{ファルス・グラタン B}\label{farcegratinb}}
...
\hypertarget{farcegratinc}{%
\subsubsection{ファルス・グラタン C}\label{farcegratinc}}
...
\end{recette}
\hypertarget{farcespourlespiecesfroides}{%
\subsection{冷製料理用のファルス}\label{farcespourlespiecesfroides}}
...
froides}\label{farce-pour-les-pieces-froides}}
...
\normalfont
\begin{recette}
\hypertarget{asssaisonnementetliaison}{%
\subsubsection{味付けと「つなぎ」}\label{asssaisonnementetliaison}}
...
\hypertarget{selepice}{%
\subsubsection{スパイスソルト}\label{selepice}}
...
\hypertarget{farce-porc}{%
\subsubsection{ファルス A （豚肉）}\label{farce-porc}}

\hypertarget{farce-froide-a}{%
\paragraph{Farce A (Porc)}\label{farce-froide-a}}
...
これはごく標準的なパテアンクルートやテリーヌに用いられる。

\textbf{ソーセージ用の挽肉}\footnote{chair à saucisses
  （シェーラソシス）。}と同じものだ。

\maeaki

\hypertarget{farce-veau-et-porc}{%
\subsubsection{ファルス B （仔牛肉と豚肉）}\label{farce-veau-et-porc}}

\hypertarget{farce-froide-b}{%
\paragraph{Farce A (Porc)}\label{farce-froide-b}}
...
\item
  \textbf{作業手順}\ldots{}\ldots{}仔牛肉、豚肉、背脂を別々に細かく刻む。調味料とともに鉢に入れてよくすり潰し、最後に、火を点けてアルコールをとばした\footnote{flamber
    （フロンベ）。フランベする。鍋に入れて火にかけるとコニャックのようにアルコール度の高い酒類はすぐにアルコール分が揮発して非常に燃えやすくなる。}コニャックを加える。裏漉しする。
\end{itemize}
