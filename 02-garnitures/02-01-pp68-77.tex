...
\subsubsection{A.
氷を入れて作るゴディヴォ}\label{godiveau-mouille-a-la-glace}}
...
\frsub{Godiveau Lyonnais ou Farce de Brochet à la graisse}\footnote{このレシピは第二版以降。}
...
\textbf{作業手順}\ldots{}\ldots{}肉と背脂は別々にして、それぞれ細かく刻む。これを鉢に入れて合わせ、調味料を加える。細かくすり潰しながら卵を一個ずつ加えていく。コナックは最後に加えること。裏漉しする。
...
\subsection{魚のブレゼのガルニチュール用ファルス}\label{farces-speciales-pour-garnir-les-poissons-braises}}
...
\index{farce@farce!poissons braises a@---s spéciales pour les poissons braisés}
\index{garniture@garniture!farce!farce poissons braises a@Farce spéciale pour les poissons braisés}
