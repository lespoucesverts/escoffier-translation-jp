...
（[羊のコトレット　モングラ](#cotelettes-monglas)その他に用いられる）

以下の材料を通常より太めで短かい千切り[^7]にする。[赤く漬けた舌
肉](#saumure-liquide-pour-langues)150 g、フォワグラ150 g、茹でたマッシュ
ルーム100 g、トリュフ100 g。
...
[^37]: bonne femme（ボヌファム）は「おばさん」くらいの意。家庭風あるいは田舎風の比較的素朴さを感じさせる料理に付けられる名称。
...
#### 皿に敷いて料理をのせる台、タンポン、クルスタード {#fonds-de-plats}
...
#### クリビヤック用[^44]セモリナ粉のカシュ {#kache-de-semoule-pour-coulibiac}
...
け蓋をして蒸し煮し[^46]、少量の白ワインでデグラセ[^47]する。

[^45]: 1935年以来、首相官邸として使われているマティニョン館を18世紀に
    ...
    理でしかほとんど用いられない(p.167)」とされている。

[^46]: étuver （エチュヴェ）。

[^47]: déglacer （デグラセ）肉汁などが加熱により濃縮して鍋底に貼り付い
    ているのを、何らかの液体を少量注いで溶かし出す作業。
...
[^48]: 18世紀にガストン・ピエール・レヴィ・ミルポワ公爵（1699〜1757）
    ...
    それは、さいの目に切った仔腿肉2 kgとハム750 g、器具を使っておろす
    かさいの目に刻んだ豚背脂750 g、さいの目に切ったにんじん5〜6本、玉
...
[^49]: brunoise （ブリュノワーズ）厳密には1〜2 mmのさいの目に刻んだもの（刻む
    こと）。ここではマティニョンよりは小さめに、とあるので3〜5 mmくらいと考えてもいい。
...
[^61]: crosne ちょろぎ。シソ科の根菜（正確には塊茎が食用となる）。中国原産で日本には江戸時代に伝わったもので、ヨーロッパにも伝わり、フランスでは最初に栽培された地名からcrosne、あるいは日本由来のものとしてcrosne du Japon（クローヌデュジャポン）と呼ばれる。絵画などの分野でジャポニスムが流行したことに食材として注目を浴びたためか、(à la) japonaise （アラ ジャポネーズ）「日本風」を冠したものには、このちょろぎを用いた料理が多い。
