...
鶏のコンソメ。
ガルニチュール；鶏手羽をデゾセし詰め物をし、ブレゼした物。粒が残るようにポシェした米。
...
鶏のコンソメ1 Lあたり、茹でたタピオカをスプーン3 杯を加え布で漉してリエしたもの。
ガルニチュール；鶏の胸肉を極細く切ったもの。鶏のファルスの、すじを入れた小さなクネル。レタスのシフォナード。
...
コンソメ・プティット・マルミット
ガルニチュール；皇帝風パンの形に整えたパイ生地の中をくり抜き、大きなデに切ったマルミット風野菜を詰めた物。これらのパイは十分な深さのある陶製の器に入れ、コンソメ・グラで1 時間半、弱火で煮て提供する際に軽くグラチネする。
...
鶏のコンソメ。
ガルニチュール；くり抜き氷に落とした人参、ブイヨンで茹でた蕪、しっかりと黒いトリュフ、新鮮なプティ・ポワを、道具を使う等して、全て小さな丸い形に揃える。大きめの丸い形にした鶏のファルスは、提供の際にポシェする。アスパラガスの穂先を小さなロンデルに切り揃えたもの。
...
ポタージュ1 Lあたり、スプーン2 杯のしっかりと赤いトマトのピュレを加え、布で漉した鶏のコンソメにタピオカを少量入れたもの。
ガルニチュール；鶏の胸肉を極細くジュリエンヌに切ったもの1 枚。
...
鶏のコンソメ。
ガルニチュール：セモリナ粉で作った小さな[ニョッキ](#gnoki) を軽く焦げ目をつけて、別添で供する。
...
要するに、[コンソメ・プランタニエ](#consomme-printanier) に出来るだけ変化をつけたものだ。
...
コンソメ2 Lあたり、赤い人参300 g、蕪200 g、ポワローの白い部分3 本分、小さいセロリ2 本、小さい玉ねぎ $\frac{1}{2}$ 個を用意する。
これらの野菜を、3 mm角に切り、塩ひとつまみと粉砂糖ひとつまみで調味し、バターでじっくりとエチュベし、野菜に火が通ったらコンソメ $\frac{1}{2}$ Lを入れる。
供する際に、必要量のコンソメと濃い緑色のプチポワ、小さい四角に切ったアリコヴェール、セルフィユの葉をそれぞれ大さじ1 杯加えて仕上げる。
このポタージュは、ガルニチュールを1 種類増やすことで違うヴァリエーションも可能であるが、その場合は表記すること。
例えば、小さい[ウフポシェ](#oeufs-pochés) を加えると、ブリュノワーズ・コルベール風となり、小さいクネル、精白大麦、米、パスタ、などの場合は、ブリュノワーズ・クネル入り、大麦入り、米入りなどとする。
ブリュノワーズは、ヴルーテのとろみ付けに用いるピュレのベースにすることも出来る。
...
通常のコンソメをクラリフィエする際に、コンソメ1 Lあたり、ポワヴロン大さじ $\frac{1}{4}$ 杯、トマトエッセンスまたはしっかりと煮詰めたトマトのピュレ大さじ4 杯を加えて風味付けする。
