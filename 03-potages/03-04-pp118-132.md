...
非常に澄んで濃い牛のコンソメ。
ガルニチュール；ごく細いキャベツのジュリエンヌ、小さなアリコヴェールを菱形になるように切ったもの、イタリア風パート。これらは、コンソメ1 Lあたりそれぞれスプーン1　杯半の割合で加える。
...
鶏のコンソメ。
ガルニチュール；スムールのニョッキを軽くグラチネしたものを別皿で提供する。
...
コンソメ・プティット・マルミット
ガルニチュール；シューブレゼを小さな球体にしたもの。新鮮な牛のモワルのロンデルをコンソメでポシェして、小さなトーストの上に載せたもの。このトーストは別皿で提供する。
...
鶏のコンソメをタピオカで軽くリエしたもの。
ガルニチュール；手に入るはしりの野菜を、形式に沿ってまたは他のやり方で、コンポートにしたもの。
要するに、コンソメ・プランタニエを変化させたものでもある。
