...
{[}{]}(注記\ldots{}\ldots{}日本語のよみがなは、濁音や促音(小さい「つ」）拗音「ゅ、ょ」などは使わずに書いてください)
\begin{recette}
...
\hypertarget{consomme-edouard-ux2166}{%
\subsubsection{コンソメ・エドワード７世}\label{consomme-edouard-ux2166}}
...
\hypertarget{consomme-}{%
\subsubsection{コンソメ・}\label{consomme-}}

\frsub{Consommé }

\index{consomme@consommé!@--- } \index{@!consomme@consommé ---}
\index{こんそめ@コンソメ!@---・} \index{@!こんそめ@コンソメ・---}
\end{recette}