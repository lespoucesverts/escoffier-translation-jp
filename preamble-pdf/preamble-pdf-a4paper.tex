\documentclass[twoside,14Q,a4paper,openany]{escoffierltjsbook}
...
%\usepackage[ipaex,bold,jis2004,expert,deluxe]{luatexja-preset}
%\usepackage[yu-osx,bold,jis2004,expert,deluxe]{luatexja-preset}
...
\newenvironment{recette}{\setlength{\parindent}{0pt}\begin{normalsize}\begin{spacing}{0.85}\begin{multicols}{2}}{\end{multicols}\end{spacing}\end{normalsize}}
...
\newcommand{\frsecb}[1]{\vspace*{-.5ex}\begin{center}\hspace*{1\zw}\normalfont\headfont\fifteenq\scshape#1\normalfont\normalsize\end{center}\vspace*{1\zw}}
\makeatletter
\newcommand{\frsub}[1]{\vspace{-.5ex}\hskip -1\zw\leftskip -1\zw\textbf{#1}\leftskip 0pt}
