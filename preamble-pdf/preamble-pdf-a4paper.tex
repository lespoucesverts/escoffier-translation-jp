\documentclass[twoside,13Q,a4paper,openany]{escoffierltjsbook}
...
\newcommand{\frsub}[1]{\vspace*{-.5ex}\normalfont\bfseries\hspace*{-1\zw}\normalsize#1\normalfont\normalsize}

\newcommand{\medlarge}{\fontsize{10.5}{10.5}\selectfont}
\newcommand{\medsmall}{\fontsize{9.5}{9.5}\selectfont}
