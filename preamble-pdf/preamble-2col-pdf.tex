...
\newenvironment{recette}{\begin{small}\begin{spacing}{1.1}\begin{multicols}{2}}{\end{multicols}\end{spacing}\end{small}}
...
%  \makeatother
%\usepackage{dblfnote}
%\usepackage[bottom,perpage,marginal,stable]{footmisc}
\usepackage[bottom,perpage,hang,marginal,stable]{footmisc}
\setlength{\skip\footins}{6mm plus 2mm}
%\usepackage{footnpag}
\makeatletter
