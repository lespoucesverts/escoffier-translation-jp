\documentclass[twoside,9Q,shiroku]{escoffierltjsbook}
...
%レイアウト調整(kiku,escoffierltjsbook.cls)
%
%\setlength{\hoffset}{-25.4mm}
\setlength{\hoffset}{-11mm}
...
%\setlength{\evensidemargin}{\oddsidemargin}
%\setlength{\textwidth}{\fullwidth}%%ltjsclassesのみ有効
%\setlength{\fullwidth}{107mm}
%\setlength{\textwidth}{107mm}
%\setlength{\marginparsep}{0pt}
%\setlength{\marginparwidth}{0pt}
%\setlength{\footskip}{0pt}
...
\newenvironment{recette}{\begin{small}\begin{spacing}{1.0}\begin{multicols}{2}}{\end{multicols}\end{spacing}\end{small}}

%\newenvironment{recette}{\begin{small}\begin{multicols}{2}}{\end{multicols}\end{small}}
...
%\setlength{\skip\footins}{6mm plus 4mm minus 2mm}
%\usepackage{footnpag}
\makeatletter
...
%\newcommand{\maeaki}{\vspace*{1.25mm}}
