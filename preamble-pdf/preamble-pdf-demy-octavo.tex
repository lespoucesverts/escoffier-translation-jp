\documentclass[twoside,10Q,demy-octavo]{escoffierltjsbook}
...
\setmonofont[Ligatures=TeX,Scale=1.0]{EB Garamond}%fontspecによるフォント設定
...
%\newenvironment{recette}{\begin{small}\begin{spacing}{1.0}\end{spacing}\end{small}}
