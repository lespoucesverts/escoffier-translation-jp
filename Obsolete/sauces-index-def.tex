...
\def\srcEstragonBlanche#1#2#3#4{%
  \index[src]{estragon blanche@Estragon (blanche)!{#1}@{#2}}%
  \index[src]{えすとらこん@エストラゴン!{#3}@{#4}}}

\def\srcFinesHerbesBlanche#1#2#3#4{%
...
\def\srcRavigoteFroide#1#2#3#4{%
  \index[src]{ravigote froide@Ravigote (froide)!{#1}@{#2}}%
  \index[src]{らういこつと@ラヴィゴット!{#3}@{#4}}}
...
\def\srcBeurreAil#1#2#3#4{%
  \index[src]{beurre ail@Beurre d'Ail!{#1}@{#2}}%
  \index[src]{にんにくはたー@にんにくバター!{#3}@{#4}}}

\def\srcBeurreAnchois#1#2#3#4{%
  \index[src]{beurre anchois@Beurre d'Anchois!{#1}@{#2}}%
  \index[src]{あんちよひはたー@アンチョビバター!{#3}@{#4}}}

\def\srcBeurreAmande#1#2#3#4{%
  \index[src]{beurre amande@Beurre d'Amande!{#1}@{#2}}%
  \index[src]{あーもんとはたー@アーモンドバター!{#3}@{#4}}}

\def\srcBeurreAveline#1#2#3#4{%
  \index[src]{beurre aveline@Beurre d'Aveline!{#1}@{#2}}%
  \index[src]{ふーるたふりーぬ@ブール・ダヴリーヌ!{#3}@{#4}}}

\def\srcBeurreBercy#1#2#3#4{%
  \index[src]{beurre bercy@Beurre Bercy!{#1}@{#2}}%
  \index[src]{ふーるへるしー@ブール・ベルシー!{#3}@{#4}}}

\def\srcBeurreCaviar#1#2#3#4{%
  \index[src]{beurre caviar@Beurre de Caviar!{#1}@{#2}}%
  \index[src]{きやひあはた@キャビアバター!{#3}@{#4}}}

\def\srcBeurreChivry#1#2#3#4{%
  \index[src]{beurre chivry@Beurre Chivry!{#1}@{#2}}%
  \index[src]{ふーるしうり@ブール・シヴリー!{#3}@{#4}}}

\def\srcBeurreColbert#1#2#3#4{%
  \index[src]{beurre colbert@Beurre Colbert!{#1}@{#2}}%
  \index[src]{ふーるこるへーる@ブール・コルベール!{#3}@{#4}}}

\def\srcBeurreColorantRouge#1#2#3#4{%
  \index[src]{beurre colorant rouge@Beurre Colorant rouge!{#1}@{#2}}%
  \index[src]{いろつけようのあかいはたー@色付け用の赤いバター!{#3}@{#4}}}

\def\srcBeurreColorantVert#1#2#3#4{%
  \index[src]{beurre colorant vert@Beurre Colorant vert!{#1}@{#2}}%
  \index[src]{いろつけようのみとりのはたー@色付け用の緑のバター!{#3}@{#4}}}
