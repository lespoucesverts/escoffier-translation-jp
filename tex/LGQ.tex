...
\author{\Large{五 島　学（責任編集・訳・注釈）}\and \Large{河井 健司（訳・注釈）} \and \large{春野 裕征（訳）\and 山 本　学（訳）\and 高 橋　昇（校正）}}
\date{}
...
%%後援者一覧
%\newpage
\input{chapitres/00-avant-propos/00-benefactors}
%\newpage
...
%% II. garnitures
\input{chapitres/02-garnitures/02-01-pp68-77}
\input{chapitres/02-garnitures/02-02-pp78-82}
\input{chapitres/02-garnitures/02-03-pp83-88}%\newpage
\input{chapitres/02-garnitures/02-04-pp89-103}
...
\include{chapitres/13-legumes/13-01-pp726-727}%
\include{chapitres/13-legumes/13-02-pp728-730}
\input{chapitres/13-legumes/13-03-pp730-732}
