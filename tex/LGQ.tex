...
\documentclass[openany,10pt,a4paper]{ltjsbook}
\usepackage{amsmath}
  \let\equation\gather
...
\author{\Large{五 島　学（責任編集・訳・注釈）}\\\large{河井 健司（訳・注釈）\\春野 裕征（訳）\\山 本　学（訳）\\高 橋　昇（校正）}}

%%索引関連
\usepackage{sauceindexdef}
\usepackage{index}
%\usepackage[useindex]{spliidx}
\newindex{src}{aidx}{aind}{ソース名から料理を探す}
%\newindex{default}{bidx}{bind}{総合索引}
\makeindex
...
%%後援者一覧
%\newpage
\include{chapitres/00-avant-propos/00-benefactors}
%\newpage
...
%\layout%レイアウト数値確認用
%%%%hston blumenthal
\include{chapitres/00-avant-propos/01-heston}

\frontmatter

\include{chapitres/00-avant-propos/02-avant-propos}
...
%%%%I. Sauces 
\include{chapitres/01-sauces/01-01-pp1-12}
\include{chapitres/01-sauces/01-02-pp13-17}
\include{chapitres/01-sauces/01-03-pp18-27}
\include{chapitres/01-sauces/01-04-pp28-41}
\include{chapitres/01-sauces/01-05-pp42-46}
\include{chapitres/01-sauces/01-06-pp47-52}
\include{chapitres/01-sauces/01-07-pp53-57}
\include{chapitres/01-sauces/01-08-pp58-62}
\include{chapitres/01-sauces/01-09-pp63-67}

%%% chapitre ii. garnitures
%\include{chapitre/02-garnitures/02-00}
%% II. garnitures
\include{chapitres/02-garnitures/02-01-pp68-77}
\include{chapitres/02-garnitures/02-02-pp78-82}
\input{chapitres/02-garnitures/02-03-pp83-88}%\newpage
\include{chapitres/02-garnitures/02-04-pp89-103}
