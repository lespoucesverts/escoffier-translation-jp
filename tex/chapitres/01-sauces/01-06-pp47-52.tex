...
\section{冷製ソース}\label{sauces-froides}}
...
\subsubsection[ソース・ムスクテール
\{\#sauce-mousquetaire]{\texorpdfstring{ソース・ムスクテール\footnote{マスケット銃兵、近衛騎兵、の意。日本でも子どもむけに翻案されたもので有名な19世紀のアレクサンドル・デュマ（ペール）の小説
  \emph{Les Trois Mousquetaires} 『三銃士』の「銃士」がこれに相当する。}
\{\#sauce-mousquetaire}{ソース・ムスクテール \{\#sauce-mousquetaire}}\label{ux30bdux30fcux30b9ux30e0ux30b9ux30afux30c6ux30fcux30eb26-sauce-mousquetaire}}
...
\subsubsection{ソース・ムタルド・生クリーム入り}\label{sauce-moutarde-creme}}
...
<div class="frsecenv">Sauces Froides Anglaises</div>
...
Sauce Cambridge (\emph{Cambridge-Sauce})
...
Sauce Cumberland (\emph{Cumberland-Sauce})
...
Sauce Gloucester (\emph{Gloucester-Sauce})
...
Sauce Oxford (\emph{Oxford Sauce})
...
Sauce Raifort (\emph{Cold horseradish sauce})
