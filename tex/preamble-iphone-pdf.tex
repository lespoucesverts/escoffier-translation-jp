\documentclass[16pt,b5var]{ltjsbook}
\usepackage{amsmath}
...
\setlength{\textwidth}{110mm}%%ltjsclassesのみ有効
...
%\let\frsub\paragraph
\newenvironment{frchapenv}{\vspace*{-2\zw}\begin{center}\normalfont\headfont%
...
\newenvironment{recette}{\setlength{\parindent}{0pt}\begin{spacing}{0.8}}{\end{spacing}}
